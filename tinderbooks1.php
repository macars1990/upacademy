  ...
  <div class="container-fluid">
	...
	<div class="header container-fluid link">
		...
		<div class="buttons col-sm-4 col-sm-offset-4">
			<br>
			<button id="dislike" class="alignleft" type="button";">Não Gosto</button>
			<button id="like" class="alignright" type="button";">Gosto</button>
		</div>
	...
	<footer class="col-sm-4 col-sm-offset-4">
		<br>
		<br>
		<p style="text-align: center;" id="date"></p>
		<p style="text-align: center;">Elaborado por: MiguelAlb.</p>	
	</footer>
